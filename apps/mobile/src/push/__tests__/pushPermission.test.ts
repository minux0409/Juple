...
describe('requestPushPermission', () => {
  ...
  it('resolves granted below API 33 without prompting', async () => {
  ...
  it('resolves granted when the OS grants the runtime prompt', async () => {
    Object.defineProperty(Platform, 'OS', { value: 'android', configurable: true });
  ...
  it('resolves denied when the OS denies the runtime prompt', async () => {
    Object.defineProperty(Platform, 'OS', { value: 'android', configurable: true });
  ...
  it('resolves denied (never throws) when the native call rejects', async () => {
    Object.defineProperty(Platform, 'OS', { value: 'android', configurable: true });
    jest.spyOn(PermissionsAndroid, 'request').mockRejectedValue(new Error('native module unavailable'));
