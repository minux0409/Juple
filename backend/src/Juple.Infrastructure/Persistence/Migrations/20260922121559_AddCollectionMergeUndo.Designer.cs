...
namespace Juple.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922121559_AddCollectionMergeUndo")]
    partial class AddCollectionMergeUndo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Juple.Domain.Collections.Collection", b =>
                {
                    ...
                    b.HasIndex("UserId", "DeletedAtUtc", "Id")
            ...
            modelBuilder.Entity("Juple.Domain.Collections.CollectionItem", b =>
                {
                    ...
                    b.HasIndex("CollectionId", "SortOrder", "Id")
            ...
            modelBuilder.Entity("Juple.Domain.Collections.CollectionMergeCreatedMembership", b =>
                {
                    ...
                    b.Property<long>("CollectionItemId")
                        .HasColumnType("bigint");

                    b.Property<long>("MergeOperationId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CollectionMergeCreatedMemberships", "collections");
                });

            modelBuilder.Entity("Juple.Domain.Collections.CollectionMergeOperation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Juple.Domain.Images.AccountDeletionBlobCleanup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AccountDeletionBlobCleanups", "images");
                });
            ...
            modelBuilder.Entity("Juple.Domain.Items.InstagramMetadataRetryTask", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("InstagramMetadataRetryTasks", "items");
                });
            ...
            modelBuilder.Entity("Juple.Domain.Notifications.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Juple.Domain.Notifications.NotificationDelivery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("PushDeviceRegistrationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PushDeviceRegistrationId");
                    ...
                    b.ToTable("NotificationDeliveries", "notifications", t =>
                        {
                            t.HasCheckConstraint("CK_NotificationDeliveries_Status_Valid", "[Status] IN (0, 1, 2)");
                        });
                });
            ...
            modelBuilder.Entity("Juple.Domain.Push.PushDeviceRegistration", b =>
                {
                    ...
                    b.ToTable("PushDeviceRegistrations", "push", t =>
                        {
                            t.HasCheckConstraint("CK_PushDeviceRegistrations_Platform_Valid", "[Platform] IN (0, 1)");
                        });
                });
            ...
            modelBuilder.Entity("Juple.Domain.Collections.CollectionMergeCreatedMembership", b =>
                {
                    b.HasOne("Juple.Domain.Collections.CollectionItem", null)
                        .WithMany()
                        .HasForeignKey("CollectionItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Juple.Domain.Collections.CollectionMergeOperation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Juple.Domain.Notifications.NotificationDelivery", b =>
                {
                    b.HasOne("Juple.Domain.Notifications.Notification", null)
                        .WithMany()
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Juple.Domain.Push.PushDeviceRegistration", null)
                        .WithMany()
                        .HasForeignKey("PushDeviceRegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
